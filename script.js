...
function getMultipleChoices(n, correctAnswer, possibleChoices) {
  ...
  while (choicesArray.length < n) {
    let randomElement = getRandomElement(possibleChoices);
...
function getBreedFromURL(url) {
  ...
  return breed.split("-").reverse().join(" ").trim();
}
...
function renderButtons(choicesArray, correctAnswer) {
  ...
  function buttonHandler(e) {
    if (e.target.value === correctAnswer) {
      ...
      congratsText.innerText = "Congrats, that's a right guess! :)";
      ...
      congratsText.innerText = "Wrong choice :(";
      options.appendChild(congratsText);
    }
  }
